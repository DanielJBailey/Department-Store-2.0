...
class Product extends Component {
    ...
    render() {
        let { id, name, description, price, remove, deleting, edit, editing, add } = this.props;
        return (
            <div className="product" ref={id}>
                        ...
                        : (!editing && !deleting) ?
                            <>
                                ...
                                <button className="add-to-cart" onClick={() => {
                                    let quantity = this.refs[id].children[1].querySelector('#quantity').value;
                                    add(id, name, description, price, quantity)
                                }}>
